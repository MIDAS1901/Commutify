...
public class specificchat extends AppCompatActivity {
    ...
    Intent intent;
    String mrecievername, sendername, mreceiveruid, msenderuid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleDateFormat = new SimpleDateFormat("hh:mm a"); //a is for 24 hrs format

        msenderuid = firebaseAuth.getUid(); //holds the uid of sender
        ...
        recieverroom = mreceiveruid + msenderuid;
        ...
        if(uri.isEmpty()){
            Toast.makeText(getApplicationContext(), "Null Value Recieved!", Toast.LENGTH_SHORT).show();
        }
        else{
